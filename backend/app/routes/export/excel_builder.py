...
def _get_vm_hourly_rate(instance_prices, pricing_tier):
    """Compatibility helper for legacy export callers."""
    return float((instance_prices or {}).get(pricing_tier, 0) or 0)
