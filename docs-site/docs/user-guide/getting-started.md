...
- **Add more workloads** -- try Model Serving or FMAPI to estimate AI/ML costs. See the [Quick Reference](/user-guide/quick-reference) for a summary of all 9 workload types.
