...
# MAGIC %md
# MAGIC # Step 12: Sync Actual Usage (Actuals Ingestion)
...
# Prefer the Autoscaling endpoint credential; fall back to the stored
# password for the sync role if endpoint credentials are unavailable.
try:
