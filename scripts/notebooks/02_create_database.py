...
workload_seeds = [
    ...
    ("VECTOR_SEARCH", "AI Search", "AI Search endpoints and optional reranking",
     ...
     None, None, "SERVERLESS_REAL_TIME_INFERENCE", 5),
    ...
    ("LAKEFLOW_CONNECT", "Lakeflow Connect",
     "Managed ingestion: DLT Serverless pipeline with optional classic gateway",
     False, False, False, False, False, False, False, False, False, False, False, True, True, False,
     None, None, "DELTA_LIVE_TABLES_SERVERLESS", 20),
]
