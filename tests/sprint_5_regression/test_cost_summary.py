...
from tests.sprint_5_regression.excel_helpers import (
...
from tests.sprint_5_regression.conftest import make_all_regression_items
...
class TestEdgeCases:
    ...
    def test_single_item(self):
        from tests.sprint_5_regression.conftest import make_jobs_classic
