...
The sync notebook (scripts/notebooks/12_sync_actuals.py) runs inside a
...
NOTEBOOK = REPO_ROOT / "scripts" / "notebooks" / "12_sync_actuals.py"
...
def test_notebook_exists():
    assert NOTEBOOK.exists(), "12_sync_actuals.py notebook missing"
...
def test_bundle_job_is_daily_and_serverless():
    ...
    task = job["tasks"][0]
    assert task["notebook_task"]["notebook_path"] == "./notebooks/12_sync_actuals.py"
