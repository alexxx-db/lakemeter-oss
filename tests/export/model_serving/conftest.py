"""Shared fixtures for Sprint 5 (Model Serving) tests."""
from types import SimpleNamespace


def make_line_item(**kwargs):
    """Create a mock line item with default values for Model Serving workloads."""
    defaults = {
        "workload_type": "MODEL_SERVING",
        "workload_name": "Test Model Serving Endpoint",
